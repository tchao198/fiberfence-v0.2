...
{
    rt_kprintf("  __ _ _                __                    \n");
		rt_kprintf(" / _(_) |              / _|                   \n");
		rt_kprintf("| |_ _| |__   ___ _ __| |_ ___ _ __   ___ ___ \n");
		rt_kprintf("|  _| | '_ \\ / _ \\ '__|  _/ _ \\ '_ \\ / __/ _ \\\n");
		rt_kprintf("| | | | |_) |  __/ |  | ||  __/ | | | (_|  __/\n");
		rt_kprintf("|_| |_|_.__/ \\___|_|  |_| \\___|_| |_|\\___\\___|\n");
    rt_kprintf("        %d.%d.%d build %s\n",
               RT_VERSION, RT_SUBVERSION, RT_REVISION, __DATE__);
    rt_kprintf("    2019 - 2020 Copyright by xd-tech Co.,Ltd\n\n");
